...
#define HID_HT_SIZE1                             0x4000A // alias: ID_HT_LEFT
#define HID_HT_SIZE2                             0x4000B // alias: ID_HT_RIGHT
#define HID_HT_SIZE3                             0x4000C // alias: ID_HT_TOP
#define HID_HT_SIZE4                             0x4000D // alias: ID_HT_TOPLEFT
#define HID_HT_SIZE5                             0x4000E // alias: ID_HT_TOPRIGHT
#define HID_HT_SIZE6                             0x4000F // alias: ID_HT_BOTTOM
#define HID_HT_SIZE7                             0x40010 // alias: ID_HT_BOTTOMLEFT
#define HID_HT_SIZE8                             0x40011 // alias: ID_HT_BOTTOMRIGHT
#define HID_HT_SIZE9                             0x40012 // alias: ID_HT_BORDER
