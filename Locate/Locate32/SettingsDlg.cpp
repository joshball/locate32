...
BOOL CSettingsProperties::CKeyboardShortcutsPage::GetSubActionLabel(CString& str,CAction::Action nAction,UINT uSubAction) const
{
	...
	case CAction::ResultListItems:
		...
		case 5:
			...
			break;
		case 6:
			str.LoadString(IDS_ACTIONRESITEMOPENCONTEXTMENUSIMPLE);
			break;
		case 7:
...
void CSettingsProperties::CKeyboardShortcutsPage::EnableItems()
{
	...
	ShowState ssVerb=swHide,ssMessage=swHide;
	...
	if (nItem!=-1)
	{
		...
		{
		case CAction::ResultListItems:
			if ((CAction::ActionResultList)SendDlgItemMessage(IDC_SUBACTION,CB_GETCURSEL)==CAction::Execute)
				ssVerb=swShow;
			break;
		case CAction::Advanced:
			ssMessage=swShow;
