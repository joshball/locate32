...
#define  HFCVERSIONMS		MAKEVERSION(5,10230)
#define  HFCVERSIONLS		MAKEVERSION(5,10230)

#ifdef _DEBUG
#define  HFCVERSIONSTR		"HFC Library (DEBUG) v5.40.5.10230";
#else
#define  HFCVERSIONSTR		"HFC Library v5.40.5.10230";
#endif
