...
// Library variables
#define  HFCVERSIONMS		MAKEVERSION(6,40)
#define  HFCVERSIONLS		MAKEVERSION(8,9140)

#ifdef _DEBUG
#define  HFCVERSIONSTR		"HFC Library (DEBUG) v6.40.8.9140";
#else
#define  HFCVERSIONSTR		"HFC Library v6.40.8.9140";
#endif
