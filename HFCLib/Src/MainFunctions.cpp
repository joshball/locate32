...
// Library variables
#define  HFCVERSIONMS		MAKEVERSION(6,21)
#define  HFCVERSIONLS		MAKEVERSION(7,12250)

#ifdef _DEBUG
#define  HFCVERSIONSTR		"HFC Library (DEBUG) v6.21.7.12250";
#else
#define  HFCVERSIONSTR		"HFC Library v6.21.7.12250";
#endif
