...
#define  HFCVERSIONMS		MAKEVERSION(5,31)
#define  HFCVERSIONLS		MAKEVERSION(4,9190)

#ifdef _DEBUG
#define  HFCVERSIONSTR		"HFC Library (DEBUG) v5.31.4.9190";
#else
#define  HFCVERSIONSTR		"HFC Library v5.31.4.9190";
#endif
